        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8 pb-10">
          <div className="space-y-2 w-full col-span-2">
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                General Information about your AI Friend
              </p>
            </div>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    Select a category for your AI Friend
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormDescription>
                  Describe in detail your AI friend&apos;s backstory and relevant details.
                </FormDescription>
                <FormMessage />
              </FormItem>
            )}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormDescription>
                  Write couple of examples of a human chatting with your AI friend, write expected answers.
                </FormDescription>
                <FormMessage />
              </FormItem>
            )}
          ...
          <div className="w-full flex justify-center">
            <Button size="lg" disabled={isLoading}>
              {initialData ? "Edit your Friend" : "Create your AI Friend"}
